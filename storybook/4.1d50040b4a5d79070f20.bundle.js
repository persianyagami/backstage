/*! For license information please see 4.1d50040b4a5d79070f20.bundle.js.LICENSE.txt */
    ...
    3103: function (module, exports, __webpack_require__) {
      module.exports = (function () {
        ...
        var TokenType,
              ...
              (Trie.prototype.get = function (codePoint) {
                ...
                if (codePoint >= 0) {
                  ...
                  if (codePoint <= 65535)
                    return (
                      (ix =
                        ((ix = this.index[2048 + ((codePoint - 55296) >> 5)]) <<
                          2) +
                        (31 & codePoint)),
                      this.data[ix]
                    );
          ...
          UnicodeTrie = (function (base64) {
            var view,
              ...
              index = slice16(view16, 12, view32[4] / 2),
              data =
                2 === view32[5]
                  ? slice16(view16, (24 + view32[4]) / 2)
                  : ((view = view32),
          ...
          LINE_BREAKS = HARD_LINE_BREAKS.concat(SPACE),
          ...
          _lineBreakAtIndex = function (
            ...
            if (-1 !== HARD_LINE_BREAKS.indexOf(next)) return "×";
            if (-1 !== SPACE.indexOf(next)) return "×";
            if (8 === previousNonSpaceClassType(currentIndex, classTypes))
              return "÷";
            if (
              11 === UnicodeTrie.get(codePoints[currentIndex]) &&
              (next === ID || next === EB || next === EM)
            )
              return "×";
            if (7 === current || 7 === next) return "×";
            if (9 === current) return "×";
            if (-1 === [SP, BA, HY].indexOf(current) && 9 === next) return "×";
            if (-1 !== [CL, CP, EX, IS, SY].indexOf(next)) return "×";
            if (previousNonSpaceClassType(currentIndex, classTypes) === OP)
              return "×";
            if (isAdjacentWithSpaceIgnored(23, OP, currentIndex, classTypes))
              return "×";
            if (
              isAdjacentWithSpaceIgnored([CL, CP], NS, currentIndex, classTypes)
            )
              return "×";
            if (isAdjacentWithSpaceIgnored(12, 12, currentIndex, classTypes))
              return "×";
            if (current === SP) return "÷";
            if (23 === current || 23 === next) return "×";
            if (16 === next || 16 === current) return "÷";
            if (-1 !== [BA, HY, NS].indexOf(next) || 14 === current) return "×";
            if (36 === before && -1 !== HYPHEN.indexOf(current)) return "×";
            if (current === SY && 36 === next) return "×";
            if (
              next === IN &&
              -1 !== ALPHABETICS.concat(IN, EX, NU, ID, EB, EM).indexOf(current)
            )
              return "×";
            if (
              (-1 !== ALPHABETICS.indexOf(next) && current === NU) ||
              (-1 !== ALPHABETICS.indexOf(current) && next === NU)
            )
              return "×";
            if (
              (current === PR && -1 !== [ID, EB, EM].indexOf(next)) ||
              (-1 !== [ID, EB, EM].indexOf(current) && next === PO)
            )
              return "×";
            if (
              ...
              return "×";
            if (
              (-1 !== [PR, PO].indexOf(current) &&
                (next === NU ||
                  (-1 !== [OP, HY].indexOf(next) &&
                    classTypes[afterIndex + 1] === NU))) ||
              (-1 !== [OP, HY].indexOf(current) && next === NU) ||
              (current === NU && -1 !== [NU, SY, IS].indexOf(next))
            )
              return "×";
            if (-1 !== [NU, SY, IS, CL, CP].indexOf(next))
              for (var prevIndex = currentIndex; prevIndex >= 0; ) {
                if ((type = classTypes[prevIndex]) === NU) return "×";
                if (-1 === [SY, IS].indexOf(type)) break;
                prevIndex--;
              }
            if (-1 !== [PR, PO].indexOf(next))
              for (
                prevIndex =
                  -1 !== [CL, CP].indexOf(current) ? beforeIndex : currentIndex;
                prevIndex >= 0;
            ...
            if (
              (JL === current && -1 !== [JL, JV, H2, H3].indexOf(next)) ||
              (-1 !== [JV, H2].indexOf(current) &&
                -1 !== [JV, JT].indexOf(next)) ||
              (-1 !== [JT, H3].indexOf(current) && next === JT)
            )
              return "×";
            if (
              (-1 !== KOREAN_SYLLABLE_BLOCK.indexOf(current) &&
                -1 !== [IN, PO].indexOf(next)) ||
              (-1 !== KOREAN_SYLLABLE_BLOCK.indexOf(next) && current === PR)
            )
              return "×";
            if (
              -1 !== ALPHABETICS.indexOf(current) &&
              ...
              return "×";
            if (current === IS && -1 !== ALPHABETICS.indexOf(next)) return "×";
            if (
              (-1 !== ALPHABETICS.concat(NU).indexOf(current) && next === OP) ||
              (-1 !== ALPHABETICS.concat(NU).indexOf(next) && current === CP)
            )
              return "×";
            if (41 === current && 41 === next) {
              for (
                var i = indicies[currentIndex], count = 1;
                i > 0 && 41 === classTypes[--i];
                ...
                return (
                  codePoints.forEach(function (codePoint, index) {
                    ...
                    if (
                      ...
                      return indicies.push(index), types.push(16);
                    if (4 === classType || 11 === classType) {
                      if (0 === index)
                        return indicies.push(index), types.push(AL);
                      var prev = types[index - 1];
                      return -1 === LINE_BREAKS.indexOf(prev)
                        ? (indicies.push(indicies[index - 1]), types.push(prev))
                        : (indicies.push(index), types.push(AL));
                    }
                    return (
                      indicies.push(index),
                      31 === classType
                        ? types.push("strict" === lineBreak ? NS : ID)
                        : classType === SA || 29 === classType
                        ? types.push(AL)
                        : 43 === classType
                  ...
                  [indicies, types, categories]
                );
              })(codePoints, options.lineBreak),
              indicies = _a[0],
              classTypes = _a[1],
              isLetterNumber = _a[2];
            return (
              ("break-all" !== options.wordBreak &&
                ...
                (classTypes = classTypes.map(function (type) {
                  return -1 !== [NU, AL, SA].indexOf(type) ? ID : type;
                })),
              [
                indicies,
                classTypes,
        ...
        var isDigit = function (codePoint) {
          ...
          LEFT_PARENTHESIS_TOKEN = { type: TokenType.LEFT_PARENTHESIS_TOKEN },
          RIGHT_PARENTHESIS_TOKEN = { type: TokenType.RIGHT_PARENTHESIS_TOKEN },
          COMMA_TOKEN = { type: TokenType.COMMA_TOKEN },
          SUFFIX_MATCH_TOKEN = { type: TokenType.SUFFIX_MATCH_TOKEN },
          PREFIX_MATCH_TOKEN = { type: TokenType.PREFIX_MATCH_TOKEN },
          COLUMN_TOKEN = { type: TokenType.COLUMN_TOKEN },
          DASH_MATCH_TOKEN = { type: TokenType.DASH_MATCH_TOKEN },
          INCLUDE_MATCH_TOKEN = { type: TokenType.INCLUDE_MATCH_TOKEN },
          LEFT_CURLY_BRACKET_TOKEN = {
          ...
          SUBSTRING_MATCH_TOKEN = { type: TokenType.SUBSTRING_MATCH_TOKEN },
          BAD_URL_TOKEN = { type: TokenType.BAD_URL_TOKEN },
          BAD_STRING_TOKEN = { type: TokenType.BAD_STRING_TOKEN },
          CDO_TOKEN = { type: TokenType.CDO_TOKEN },
          CDC_TOKEN = { type: TokenType.CDC_TOKEN },
          COLON_TOKEN = { type: TokenType.COLON_TOKEN },
          SEMICOLON_TOKEN = { type: TokenType.SEMICOLON_TOKEN },
          LEFT_SQUARE_BRACKET_TOKEN = {
          ...
          WHITESPACE_TOKEN = { type: TokenType.WHITESPACE_TOKEN },
            ...
            return (
                ...
                switch (codePoint) {
                  ...
                  case 64:
                    var a1 = this.peekCodePoint(0),
                      a2 = this.peekCodePoint(1),
                      a3 = this.peekCodePoint(2);
                    if (isIdentifierStart(a1, a2, a3))
                      return (
                        (value = this.consumeName()),
                        { type: TokenType.AT_KEYWORD_TOKEN, value: value }
                      );
                    break;
                  case 91:
              ...
              (Tokenizer.prototype.consumeUnicodeRangeToken = function () {
                ...
                if (
                  ...
                  return (
                    (end = parseInt(
                      fromCodePoint.apply(void 0, endDigits),
                      16
                    )),
                    {
                      type: TokenType.UNICODE_RANGE_TOKEN,
              ...
              (Tokenizer.prototype.consumeIdentLikeToken = function () {
                ...
                return "url" === value.toLowerCase() &&
                  ...
                  : { type: TokenType.IDENT_TOKEN, value: value };
              }),
              (Tokenizer.prototype.consumeUrlToken = function () {
                ...
                if (39 === next || 34 === next) {
                  ...
                  return stringToken.type === TokenType.STRING_TOKEN &&
                    (this.consumeWhiteSpace(),
                    -1 === this.peekCodePoint(0) ||
                      41 === this.peekCodePoint(0))
                    ? (this.consumeCodePoint(),
                      { type: TokenType.URL_TOKEN, value: stringToken.value })
                    : (this.consumeBadUrlRemnants(), BAD_URL_TOKEN);
                }
                for (;;) {
                  var codePoint = this.consumeCodePoint();
                  if (-1 === codePoint || 41 === codePoint)
                    return {
                ...
                for (var value = "", i = 0; ; ) {
                  ...
                  if (
                    ...
                    return (
                      ...
                      { type: TokenType.STRING_TOKEN, value: value }
                    );
                  if (10 === codePoint)
            ...
            return (
              tokens.forEach(function (token) {
                if (token.type === TokenType.COMMA_TOKEN) {
                  ...
                  return args.push(arg), void (arg = []);
                }
                token.type !== TokenType.WHITESPACE_TOKEN && arg.push(token);
              }),
          ...
          ZERO_LENGTH = { type: TokenType.NUMBER_TOKEN, number: 0, flags: 4 },
          FIFTY_PERCENT = {
            type: TokenType.PERCENTAGE_TOKEN,
            number: 50,
            flags: 4,
          ...
          isAngle = function (value) {
            return (
              value.type === TokenType.DIMENSION_TOKEN &&
              ("deg" === value.unit ||
                "grad" === value.unit ||
                "rad" === value.unit ||
                "turn" === value.unit)
          ...
          color_parse = function (value) {
            ...
            if (value.type === TokenType.HASH_TOKEN) {
              ...
              if (6 === value.value.length)
                return (
                  (r = value.value.substring(0, 2)),
                  (g = value.value.substring(2, 4)),
                  (b = value.value.substring(4, 6)),
                  pack(parseInt(r, 16), parseInt(g, 16), parseInt(b, 16), 1)
                );
        ...
        var PropertyDescriptorParsingType,
          ...
          hsl = function (args) {
            ...
            return pack(255 * r, 255 * g, 255 * b, a);
          },
        ...
        (function (PropertyDescriptorParsingType) {
          ...
          (function (BACKGROUND_CLIP) {
            (BACKGROUND_CLIP[(BACKGROUND_CLIP.BORDER_BOX = 0)] = "BORDER_BOX"),
              (BACKGROUND_CLIP[(BACKGROUND_CLIP.PADDING_BOX = 1)] =
                "PADDING_BOX"),
              (BACKGROUND_CLIP[(BACKGROUND_CLIP.CONTENT_BOX = 2)] =
                "CONTENT_BOX");
        ...
        var CSSImageType,
          ...
          parseColorStop = function (args) {
            var color$1 = color_parse(args[0]),
              stop = args[1];
          ...
          processColorStops = function (stops, lineLength) {
            ...
            var gapBegin = null;
            for (i = 0; i < processStops.length; i++) {
          ...
          calculateGradientDirection = function (angle, width, height) {
            var radian =
                "number" == typeof angle
                  ? angle
                  : (function (corner, width, height) {
                      var centerX = width / 2,
                        centerY = height / 2,
                        x = getAbsoluteValue(corner[0], width) - centerX,
                        y = centerY - getAbsoluteValue(corner[1], height);
          ...
          findCorner = function (width, height, x, y, closest) {
            return [
              ...
              { optimumDistance: closest ? 1 / 0 : -1 / 0, optimumCorner: null }
            ).optimumCorner;
          },
          prefixLinearGradient = function (tokens) {
            var angle$1 = deg(180),
              stops = [];
            return (
              parseFunctionArgs(tokens).forEach(function (arg, i) {
                if (0 === i) {
                  ...
                  if (
                    ...
                    return void (angle$1 = parseNamedSide(arg));
                  if (isAngle(firstToken))
                    return void (angle$1 =
                      (angle_parse(firstToken) + deg(270)) % deg(360));
                }
          ...
          FEATURES = {
            ...
            get SUPPORT_CORS_IMAGES() {
              var value = void 0 !== new Image().crossOrigin;
              return (
            ...
            get SUPPORT_RESPONSE_TYPE() {
              var value = "string" == typeof new XMLHttpRequest().responseType;
              return (
          ...
          Cache = (function () {
            function Cache(id, options) {
              (this.id = id), (this._options = options), (this._cache = {});
            }
            return (
              (Cache.prototype.addImage = function (src) {
                ...
                return this.has(src)
                  ...
                  ? ((this._cache[src] = this.loadImage(src)), result)
                  : result;
              }),
          ...
          prefixRadialGradient = function (tokens) {
                    ...
                    : 1 === i &&
                      (isColorStop = arg.reduce(function (acc, token) {
                        if (isIdentToken(token))
                          switch (token.value) {
                            case "circle":
                              return (shape = CSSRadialShape.CIRCLE), !1;
                            case "ellipse":
                              return (shape = CSSRadialShape.ELLIPSE), !1;
                            case "contain":
                            case "closest-side":
                              return (size = CSSRadialExtent.CLOSEST_SIDE), !1;
                            case "farthest-side":
                              return (size = CSSRadialExtent.FARTHEST_SIDE), !1;
                            case "closest-corner":
                              return (
                                (size = CSSRadialExtent.CLOSEST_CORNER), !1
                              );
                            case "cover":
                            case "farthest-corner":
                              return (
                                (size = CSSRadialExtent.FARTHEST_CORNER), !1
                              );
                          }
        ...
        var BACKGROUND_REPEAT,
          image_parse = function (value) {
            if (value.type === TokenType.URL_TOKEN) {
              var image_1 = { url: value.value, type: CSSImageType.URL };
              return CacheStorage.getInstance().addImage(value.value), image_1;
            }
            if (value.type === TokenType.FUNCTION) {
          ...
          SUPPORTED_IMAGE_FUNCTIONS = {
            "linear-gradient": function (tokens) {
              var angle$1 = deg(180),
                stops = [];
              return (
                parseFunctionArgs(tokens).forEach(function (arg, i) {
                  if (0 === i) {
                    ...
                    if (
                      ...
                      return void (angle$1 = parseNamedSide(arg));
                    if (isAngle(firstToken))
                      return void (angle$1 = angle_parse(firstToken));
                  }
                  var colorStop = parseColorStop(arg);
                  stops.push(colorStop);
                }),
            ...
            "radial-gradient": function (tokens) {
              var shape = CSSRadialShape.CIRCLE,
                size = CSSRadialExtent.FARTHEST_CORNER,
                stops = [],
                position = [];
                    ...
                    isColorStop = arg.reduce(function (acc, token) {
                      if (isAtPosition_1)
                        if (isIdentToken(token))
                          switch (token.value) {
                            case "center":
                              return position.push(FIFTY_PERCENT), acc;
                            case "top":
                            case "left":
                              return position.push(ZERO_LENGTH), acc;
                            case "right":
                            case "bottom":
                              return position.push(HUNDRED_PERCENT), acc;
                          }
                        else
                        ...
                        switch (token.value) {
                          ...
                          case "contain":
                          case "closest-corner":
                            return (size = CSSRadialExtent.CLOSEST_CORNER), !1;
                          case "farthest-corner":
                            return (size = CSSRadialExtent.FARTHEST_CORNER), !1;
                        }
                      else if (isLength(token) || isLengthPercentage(token))
                        return (
                          Array.isArray(size) || (size = []),
            ...
            "-webkit-gradient": function (tokens) {
              var angle = deg(180),
                stops = [],
                type = CSSImageType.LINEAR_GRADIENT,
                ...
                parseFunctionArgs(tokens).forEach(function (arg, i) {
                  ...
                  if (0 === i) {
                    if (
                      ...
                      return void (type = CSSImageType.LINEAR_GRADIENT);
                    if (
                      isIdentToken(firstToken) &&
                      "radial" === firstToken.value
                    )
                      return void (type = CSSImageType.RADIAL_GRADIENT);
                  }
                  if (firstToken.type === TokenType.FUNCTION)
                    if ("from" === firstToken.name) {
                      var color$1 = color_parse(firstToken.values[0]);
                      stops.push({ stop: ZERO_LENGTH, color: color$1 });
                    } else if ("to" === firstToken.name)
                      (color$1 = color_parse(firstToken.values[0])),
          ...
          backgroundImage = {
            ...
            parse: function (tokens) {
              ...
              var first = tokens[0];
              return first.type === TokenType.IDENT_TOKEN &&
                "none" === first.value
                ? []
                : tokens
        ...
        !(function (BACKGROUND_REPEAT) {
          (BACKGROUND_REPEAT[(BACKGROUND_REPEAT.REPEAT = 0)] = "REPEAT"),
            (BACKGROUND_REPEAT[(BACKGROUND_REPEAT.NO_REPEAT = 1)] =
              "NO_REPEAT"),
        ...
        !(function (LINE_BREAK) {
          (LINE_BREAK.NORMAL = "normal"), (LINE_BREAK.STRICT = "strict");
        ...
        !(function (LIST_STYLE_POSITION) {
          (LIST_STYLE_POSITION[(LIST_STYLE_POSITION.INSIDE = 0)] = "INSIDE"),
            (LIST_STYLE_POSITION[(LIST_STYLE_POSITION.OUTSIDE = 1)] =
              "OUTSIDE");
        ...
        !(function (LIST_STYLE_TYPE) {
          (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.NONE = -1)] = "NONE"),
            ...
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.CJK_DECIMAL = 4)] =
              "CJK_DECIMAL"),
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.DECIMAL_LEADING_ZERO = 5)] =
              "DECIMAL_LEADING_ZERO"),
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.LOWER_ROMAN = 6)] =
              "LOWER_ROMAN"),
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.UPPER_ROMAN = 7)] =
              "UPPER_ROMAN"),
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.LOWER_GREEK = 8)] =
              "LOWER_GREEK"),
            (LIST_STYLE_TYPE[(LIST_STYLE_TYPE.LOWER_ALPHA = 9)] =
              "LOWER_ALPHA"),
                    ...
                    for (
                      ...
                      isLength(token)
                        ? (0 === c
                            ...
                            : (shadow.blur = token),
                          c++)
                        : (shadow.color = color_parse(token));
                    }
                    return shadow;
                  });
            },
        ...
        var PseudoElementType,
          ...
          counterReset = {
            ...
            parse: function (tokens) {
              if (0 === tokens.length) return [];
              for (
                var resets = [], filtered = tokens.filter(nonWhiteSpace), i = 0;
                i < filtered.length;
                i++
              ) {
                var counter = filtered[i],
            ...
            switch (descriptor.type) {
              ...
              case PropertyDescriptorParsingType.TYPE_VALUE:
                switch (descriptor.format) {
                  case "angle":
                    return angle_parse(parser.parseComponentValue());
                  case "color":
                    return color_parse(parser.parseComponentValue());
                  case "image":
                    return image_parse(parser.parseComponentValue());
                  case "length":
          ...
          ElementContainer = function ElementContainer(element) {
          ...
          getWrapperBounds = function (node) {
          ...
          getRangeBounds = function (node, offset, length) {
            var ownerDocument = node.ownerDocument;
            ...
            return (
              ...
              Bounds.fromClientRect(range.getBoundingClientRect())
            );
          },
          ...
          breakWords = function (str, styles) {
            for (
                  ...
                  return {
                    next: function () {
                      ...
                      if ("×" !== lineBreak || nextIndex === length) {
                        ...
                        return (
                          (lastEnd = nextIndex), { value: value, done: !1 }
                        );
                      }
              ...
              bk.value && words.push(bk.value.slice());
            return words;
          },
          TextContainer = function TextContainer(node, styles) {
            (this.text = transform$1(node.data, styles.textTransform)),
              (this.textBounds = (function (value, styles, node) {
                  ...
                  textList.forEach(function (text) {
                    if (
                      ...
                      if (FEATURES.SUPPORT_RANGE_BOUNDS)
                        ...
                        textBounds.push(
                          new TextBounds(text, getWrapperBounds(node))
                        ),
              ...
              })(this.text, styles, node));
          },
          transform$1 = function (text, transform) {
            switch (transform) {
          ...
          RADIO_BORDER_RADIUS = [
            { type: TokenType.PERCENTAGE_TOKEN, flags: 0, number: 50 },
          ],
          PASSWORD = "password",
              ...
              switch (
                ...
                (_this.value =
                  ...
                  (value =
                    ...
                    ? node.placeholder || ""
                    : value),
                ("checkbox" !== _this.type && "radio" !== _this.type) ||
          ...
          parseColor = function (value) {
            return color_parse(Parser.create(value).parseComponentValue());
          },
          ...
          parseNodeTree = function (node, parent, root) {
            for (
          ...
          createContainer = function (element) {
            return isImageElement(element)
              ? new ImageElementContainer(element)
              : isCanvasElement(element)
              ? new CanvasElementContainer(element)
              : isSVGElement(element)
              ? new SVGElementContainer(element)
              : isLIElement(element)
              ? new LIElementContainer(element)
              : isOLElement(element)
              ? new OLElementContainer(element)
              : isInputElement(element)
              ? new InputElementContainer(element)
              : isSelectElement(element)
              ? new SelectElementContainer(element)
              : isTextareaElement(element)
              ? new TextareaElementContainer(element)
              : isIFrameElement(element)
              ? new IFrameElementContainer(element)
              : new ElementContainer(element);
          },
                          ...
                          case 0:
                            return (
                              ...
                              void 0 === this.clonedReferenceElement
                                ...
                                ? [4, documentClone.fonts.ready]
                                : [3, 2]
                            );
                          case 1:
                            _a.sent(), (_a.label = 2);
                          case 2:
                            return "function" == typeof onclone
                              ? [
                                  2,
                                  Promise.resolve()
                                    .then(function () {
              ...
              (DocumentCloner.prototype.cloneNode = function (node) {
                ...
                if (
                  ...
                  var clone = this.createElementClone(node),
                    ...
                    styleBefore = window.getComputedStyle(node, ":before"),
                    styleAfter = window.getComputedStyle(node, ":after");
                  ...
                  for (
                    ...
                    (isElementNode(child) &&
                      (isScriptElement(child) ||
                        child.hasAttribute("data-html2canvas-ignore") ||
                ...
                if (style) {
                  ...
                  if (
                    ...
                    var declaration = new CSSParsedPseudoDeclaration(style),
                      anonymousReplacedElement = document.createElement(
                        ...
                        if (token.type === TokenType.STRING_TOKEN)
                          ...
                          if ("attr" === token.name) {
                            ...
                            var _b = token.values.filter(
                              ...
                              delim = ((counter = _b[0]), _b[1]);
                            if (
                              ((counterStyle = _b[2]),
                              counter && isIdentToken(counter))
                            ) {
        ...
        var PathType,
          createIFrameContainer = function (ownerDocument, bounds) {
            ...
            return (
              ...
              cloneIframeContainer.setAttribute(
        ...
        var CORNER,
          ...
          Vector = (function () {
            function Vector(x, y) {
              (this.type = PathType.VECTOR), (this.x = x), (this.y = y);
            }
            return (
        ...
        var getCurvePoints = function (x, y, r1, r2, position) {
          ...
          ClipEffect = function ClipEffect(path, target) {
            (this.type = 1), (this.target = target), (this.path = path);
          },
            ...
            function ElementPaint(element, parentStack) {
              if (
                ...
                var offsetX =
                  ...
                  offsetY =
                    element.bounds.top +
                    element.styles.transformOrigin[1].number,
                  matrix = element.styles.transform;
                this.effects.push(
              ...
              (ElementPaint.prototype.getParentEffects = function () {
                ...
                if (this.container.styles.overflowX !== OVERFLOW.VISIBLE) {
                  var borderBox = calculateBorderBoxPath(this.curves),
                    paddingBox = calculatePaddingBoxPath(this.curves);
                  equalPath(borderBox, paddingBox) ||
                    effects.push(new ClipEffect(paddingBox, 6));
                }
                return effects;
              }),
              ElementPaint
          ...
          parseStackTree = function (
            ...
            parent.container.elements.forEach(function (child) {
              var treatAsRealStackingContext = contains(child.flags, 4),
                ...
                paintContainer = new ElementPaint(
                  child,
              ...
              } else child.styles.isInlineLevel() ? stackingContext.inlineLevel.push(paintContainer) : stackingContext.nonInlineLevel.push(paintContainer), parseStackTree(paintContainer, stackingContext, realStackingContext, listOwnerItems);
          ...
          calculateBackgroundRendering = function (
            ...
            var backgroundPositioningArea = (function (
                backgroundOrigin,
                element
              ) {
                return 0 === backgroundOrigin
                  ? element.bounds
                  : 2 === backgroundOrigin
                  ? contentBox(element)
                  : paddingBox(element);
              ...
              backgroundPaintingArea = (function (backgroundClip, element) {
                return backgroundClip === BACKGROUND_CLIP.BORDER_BOX
                  ? element.bounds
          ...
          FontMetrics = (function () {
            function FontMetrics(document) {
              (this._data = {}), (this._document = document);
            }
            return (
          ...
          CanvasRenderer = (function () {
            ...
            return (
              (CanvasRenderer.prototype.applyEffects = function (
                effects,
                target
              ) {
              ...
              (CanvasRenderer.prototype.applyEffect = function (effect) {
                this.ctx.save(),
                  ...
                  })(effect) && (this.path(effect.path), this.ctx.clip()),
                ...
                return __awaiter(this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return (styles =
                          stack.element.container.styles).isVisible()
                          ? ((this.ctx.globalAlpha = styles.opacity),
                            [4, this.renderStackContent(stack)])
                          : [3, 2];
                      case 1:
                        _a.sent(), (_a.label = 2);
                      case 2:
              ...
              (CanvasRenderer.prototype.renderNode = function (paint) {
                return __awaiter(this, void 0, void 0, function () {
                  return __generator(this, function (_a) {
                    switch (_a.label) {
                      case 0:
                        return paint.container.styles.isVisible()
                          ? [4, this.renderNodeBackgroundAndBorders(paint)]
                          : [3, 3];
                      case 1:
              ...
              (CanvasRenderer.prototype.renderTextWithLetterSpacing = function (
                ...
                0 === letterSpacing
                  ...
                  : toCodePoints(text.text)
                      .map(function (i) {
                        return fromCodePoint(i);
                      })
                      .reduce(function (left, letter) {
                        return (
                          _this.ctx.fillText(
                            letter,
                            left,
                  ...
                  return __generator(this, function (_b) {
                    switch (_b.label) {
                      ...
                      case 5:
                        return (
                          _b.trys.push([5, 7, , 8]),
                          [4, this.options.cache.match(container.src)]
                        );
                      case 6:
                        return (
                          (image = _b.sent()),
                      ...
                      case 9:
                        return (
                          ...
                          [4, this.options.cache.match(container.svg)]
                        );
                      case 10:
                        return (
                          (image = _b.sent()),
                      ...
                      case 12:
                        return container instanceof IFrameElementContainer &&
                          container.tree
                          ? [
                              4,
                              new CanvasRenderer({
                      ...
                      case 14:
                        ...
                        if (null === container.styles.listStyleImage)
                          return [3, 19];
                        if (
                          (img = container.styles.listStyleImage).type !==
                          CSSImageType.URL
                        )
                          return [3, 18];
                        (image = void 0), (url = img.url), (_b.label = 15);
                      case 15:
                        return (
                          _b.trys.push([15, 17, , 18]),
                          [4, this.options.cache.match(url)]
                        );
                      case 16:
                        return (
                          (image = _b.sent()),
                      ...
                      case 19:
                        paint.listValue &&
                          ...
                          (bounds = new Bounds(
                            ...
                            container.bounds.width,
                            (function (token, fontSize) {
                              return isIdentToken(token) &&
                                "normal" === token.value
                                ? 1.2 * fontSize
                                : token.type === TokenType.NUMBER_TOKEN
                                ...
                                : fontSize;
                            })(styles.lineHeight, styles.fontSize.number) /
                              2 +
                              1
                          )),
                          this.renderTextWithLetterSpacing(
                ...
                return __awaiter(this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (_p) {
                    switch (_p.label) {
                      ...
                      case 2:
                        return _i < _a.length
                          ? ((child = _a[_i]), [4, this.renderStack(child)])
                          : [3, 5];
                      case 3:
                        _p.sent(), (_p.label = 4);
                      case 4:
                      ...
                      case 7:
                        return _b < _c.length
                          ? ((child = _c[_b]), [4, this.renderNode(child)])
                          : [3, 10];
                      case 8:
                        _p.sent(), (_p.label = 9);
                      case 9:
                      ...
                      case 15:
                        return _f < _g.length
                          ? ((child = _g[_f]), [4, this.renderStack(child)])
                          : [3, 18];
                      case 16:
                        _p.sent(), (_p.label = 17);
                      case 17:
                      ...
                      case 19:
                        return _h < _j.length
                          ? ((child = _j[_h]), [4, this.renderNode(child)])
                          : [3, 22];
                      case 20:
                        _p.sent(), (_p.label = 21);
                      case 21:
                      ...
                      case 23:
                        return _k < _l.length
                          ? ((child = _l[_k]), [4, this.renderStack(child)])
                          : [3, 26];
                      case 24:
                        _p.sent(), (_p.label = 25);
                      case 25:
                      ...
                      case 27:
                        return _m < _o.length
                          ? ((child = _o[_m]), [4, this.renderStack(child)])
                          : [3, 30];
                      case 28:
                        _p.sent(), (_p.label = 29);
                      case 29:
                            ...
                            return __generator(this, function (_f) {
                              switch (_f.label) {
                                ...
                                case 1:
                                  return (
                                    _f.trys.push([1, 3, , 4]),
                                    [4, this_1.options.cache.match(url)]
                                  );
                                case 2:
                                  return (image = _f.sent()), [3, 4];
                                case 3:
                                  return (
                                    _f.sent(),
                    ...
                    switch (_a.label) {
                      ...
                      case 2:
                        (side = 0),
                          ...
                          (_a.label = 3);
                      case 3:
                        return _i < borders_1.length
                          ? (border = borders_1[_i]).style ===
                              BORDER_STYLE.NONE || isTransparent(border.color)
                            ? [3, 5]
                            : [
                                4,
                                this.renderBorder(
                    ...
                    switch (_a.label) {
                      case 0:
                        return (
                          ...
                          (paintContainer = new ElementPaint(element, [])),
                      ...
                      case 1:
                        return (
                          _a.sent(), this.applyEffects([], 2), [2, this.canvas]
                        );
                    }
                    var paintContainer, root, listItems;
                  });
                });
              }),
              CanvasRenderer
              ...
              switch (_b.label) {
                case 0:
                  ...
                  return (
                    ...
                    (_a =
                      isBodyElement(element) || "HTML" === element.tagName
                        ? (function (document) {
                  ...
                  return (
                    ...
                    options.foreignObjectRendering
                      ? (Logger.getInstance(instanceName).debug(
                        ...
                        [
                          4,
                          new ForeignObjectRenderer(renderOptions).render(
                            clonedElement
                          ),
                        ])
                      : [3, 3]
                ...
                case 3:
                  return (
                    ...
                    [4, new CanvasRenderer(renderOptions).render(root)]
                  );
                case 4:
                  (canvas = _b.sent()), (_b.label = 5);
                case 5:
                  return (
...
//# sourceMappingURL=4.1d50040b4a5d79070f20.bundle.js.map
