/*! For license information please see 5.1d50040b4a5d79070f20.bundle.js.LICENSE.txt */
    ...
    3104: function (module, exports, __webpack_require__) {
      module.exports = (function () {
        ...
        var arrayForEach = unapply(Array.prototype.forEach),
          ...
          typeErrorCreate = (function unconstruct(func) {
            return function () {
              for (
        ...
        var getGlobal = function getGlobal() {
          ...
          _createTrustedTypesPolicy = function _createTrustedTypesPolicy(
            ...
            document.currentScript &&
              document.currentScript.hasAttribute("data-tt-policy-suffix") &&
              (suffix = document.currentScript.getAttribute(
        ...
        return (function createDOMPurify() {
          ...
          var MUSTACHE_EXPR$$1 = MUSTACHE_EXPR,
            ...
            _parseConfig = function _parseConfig(cfg) {
              (CONFIG && CONFIG === cfg) ||
                ((cfg &&
                  "object" === (void 0 === cfg ? "undefined" : _typeof(cfg))) ||
                  (cfg = {}),
                (cfg = clone(cfg)),
                (ALLOWED_TAGS =
                  "ALLOWED_TAGS" in cfg
                ...
                (RETURN_DOM_IMPORT = cfg.RETURN_DOM_IMPORT || !1),
                ...
                (IS_ALLOWED_URI$$1 =
                  cfg.ALLOWED_URI_REGEXP || IS_ALLOWED_URI$$1),
            ...
            _isNode = function _isNode(object) {
              return "object" ===
                (void 0 === Node ? "undefined" : _typeof(Node))
            ...
            _sanitizeElements = function _sanitizeElements(currentNode) {
              ...
              if (
                ...
                ("svg" === tagName || "math" === tagName) &&
                  0 !== currentNode.querySelectorAll("p, br").length)
              )
                return _forceRemove(currentNode), !0;
              if (
              ...
              if (!ALLOWED_TAGS[tagName] || FORBID_TAGS[tagName]) {
                if (
                  ...
                  "function" == typeof currentNode.insertAdjacentHTML
                )
                  try {
              ...
              return ("noscript" !== tagName && "noembed" !== tagName) ||
          ...
          return (
            (DOMPurify.sanitize = function (dirty, cfg) {
              ...
              if (
                ...
                (1 ===
                  (importedNode = (body = _initDocument(
                    "\x3c!----\x3e"
                  )).ownerDocument.importNode(dirty, !0)).nodeType &&
...
//# sourceMappingURL=5.1d50040b4a5d79070f20.bundle.js.map
